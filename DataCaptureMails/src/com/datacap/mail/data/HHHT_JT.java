 ...
 * 
 */
public class HHHT_JT extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static HHHT_JT hhht = null;
	...
	public static HHHT_JT getInstance() {
		if (hhht == null) {
			hhht = new HHHT_JT();
		}
		return hhht;
	...
	public static HHHT_JT getHHHT_JT() {
		return hhht;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "呼和浩特市公共资源交易中心-交通工程";
		mCharset = "utf-8";
		mUri = "http://www.ggzyjy.com.cn/hsweb/004/004010/004010001/MoreInfo.aspx?CategoryNum=004010001";
		while (true) {
