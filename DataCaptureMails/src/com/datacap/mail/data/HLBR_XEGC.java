 ...
 * 
 */
public class HLBR_XEGC extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static HLBR_XEGC hlbr = null;
	private String url = "http://www.hlbeggzyjy.org.cn";

	private HLBR_XEGC() {
	}

	public static HLBR_XEGC getInstance() {
		if (hlbr == null) {
			hlbr = new HLBR_XEGC();
		}
		return hlbr;
	...
	public static HLBR_XEGC getHLBR_XEGC() {
		return hlbr;
	}
