 ...
 * 
 */
public class CF_JS_JL extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static CF_JS_JL cf = null;
	...
	public static CF_JS_JL getInstance() {
		if (cf == null) {
			cf = new CF_JS_JL();
		}
		return cf;
	...
	public static CF_JS_JL getCF_JS_JL() {
		return cf;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "赤峰公共资源交易网-建设工程-监理";
		mCharset = "utf-8";
		mUri = "http://www.cfggzy.cn/cfweb/jyxx/004001/004001001/004001001003/MoreInfo.aspx?CategoryNum=004001001003";
		while (true) {
