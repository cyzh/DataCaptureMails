 ...
 * 
 */
public class CF_JS_SG extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static CF_JS_SG cf = null;
	...
	public static CF_JS_SG getInstance() {
		if (cf == null) {
			cf = new CF_JS_SG();
		}
		return cf;
	...
	public static CF_JS_SG getCF_JS_SG() {
		return cf;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "赤峰公共资源交易网-建设工程-施工";
		mCharset = "utf-8";
		mUri = "http://www.cfggzy.cn/cfweb/jyxx/004001/004001001/004001001004/MoreInfo.aspx?CategoryNum=004001001004";
		while (true) {
