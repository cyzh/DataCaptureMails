 ...
 * 
 */
public class CF_JS_SJ extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static CF_JS_SJ cf = null;
	...
	public static CF_JS_SJ getInstance() {
		if (cf == null) {
			cf = new CF_JS_SJ();
		}
		return cf;
	...
	public static CF_JS_SJ getCF_JS_SJ() {
		return cf;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "赤峰公共资源交易网-建设工程-设计";
		mCharset = "utf-8";
		mUri = "http://www.cfggzy.cn/cfweb/jyxx/004001/004001001/004001001002/MoreInfo.aspx?CategoryNum=004001001002";
		while (true) {
