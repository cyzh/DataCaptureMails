 ...
 * 
 */
public class CF_JS_HW extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static CF_JS_HW cf = null;
	...
	public static CF_JS_HW getInstance() {
		if (cf == null) {
			cf = new CF_JS_HW();
		}
		return cf;
	...
	public static CF_JS_HW getCF_JS_HW() {
		return cf;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "赤峰公共资源交易网-建设工程-货物";
		mCharset = "utf-8";
		mUri = "http://www.cfggzy.cn/cfweb/jyxx/004001/004001001/004001001005/MoreInfo.aspx?CategoryNum=004001001005";
		while (true) {
