 ...
 * 
 */
public class CF_ZF_GC extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static CF_ZF_GC cf = null;
	...
	public static CF_ZF_GC getInstance() {
		if (cf == null) {
			cf = new CF_ZF_GC();
		}
		return cf;
	...
	public static CF_ZF_GC getCF_ZF_GC() {
		return cf;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "赤峰公共资源交易网-政府采购-工程";
		mCharset = "utf-8";
		mUri = "http://www.cfggzy.cn/cfweb/jyxx/004002/004002001/004002001003/MoreInfo.aspx?CategoryNum=004002001003";
		while (true) {
