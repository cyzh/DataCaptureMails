 ...
 * 
 */
public class CF_ZF_FW extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static CF_ZF_FW cf = null;
	...
	public static CF_ZF_FW getInstance() {
		if (cf == null) {
			cf = new CF_ZF_FW();
		}
		return cf;
	...
	public static CF_ZF_FW getCF_ZF_FW() {
		return cf;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "赤峰公共资源交易网-政府采购-服务";
		mCharset = "utf-8";
		mUri = "http://www.cfggzy.cn/cfweb/jyxx/004002/004002001/004002001002/MoreInfo.aspx?CategoryNum=004002001002";
		while (true) {
