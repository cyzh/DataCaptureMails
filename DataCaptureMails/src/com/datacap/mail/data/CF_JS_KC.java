 ...
 * 
 */
public class CF_JS_KC extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static CF_JS_KC cf = null;
	...
	public static CF_JS_KC getInstance() {
		if (cf == null) {
			cf = new CF_JS_KC();
		}
		return cf;
	...
	public static CF_JS_KC getCF_JS_KC() {
		return cf;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "赤峰公共资源交易网-建设工程-勘察";
		mCharset = "utf-8";
		mUri = "http://www.cfggzy.cn/cfweb/jyxx/004001/004001001/004001001001/MoreInfo.aspx?CategoryNum=004001001001";
		while (true) {
