 ...
 * 
 */
public class CF_JS_QT extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static CF_JS_QT cf = null;
	...
	public static CF_JS_QT getInstance() {
		if (cf == null) {
			cf = new CF_JS_QT();
		}
		return cf;
	...
	public static CF_JS_QT getCF_JS_QT() {
		return cf;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "赤峰公共资源交易网-建设工程-其他";
		mCharset = "utf-8";
		mUri = "http://www.cfggzy.cn/cfweb/jyxx/004001/004001001/004001001006/MoreInfo.aspx?CategoryNum=004001001006";
		while (true) {
