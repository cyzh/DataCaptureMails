 ...
 * 
 */
public class HHHT_JS extends DataRequest {
	private static final Logger log = Logger.getLogger(DataRequest.class);
	private static HHHT_JS hhht = null;
	...
	public static HHHT_JS getInstance() {
		if (hhht == null) {
			hhht = new HHHT_JS();
		}
		return hhht;
	...
	public static HHHT_JS getHHHT_JS() {
		return hhht;
	}
	...
	protected void traversePage(CloseableHttpClient httpClient) {
		mSource = "呼和浩特市公共资源交易中心-建设工程";
		mCharset = "utf-8";
		mUri = "http://www.ggzyjy.com.cn/hsweb/004/004001/004001001/MoreInfo.aspx?CategoryNum=004001001";
		while (true) {
